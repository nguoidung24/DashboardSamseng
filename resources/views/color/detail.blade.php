        ...
        <div class="card-body">
            <div class="row row-cols-1 row-cols-sm-2">
                <div class="col mt-3">
                    ...
                    <input type="color" name="code" class="form-control form-control-color" value="{{$data['code']}}" title="Chọn màu">
                </div>
                <div class="col mt-3">
                    <label for="">Tên màu<span class="text-danger">(*)</span></label>
                    <input required class="form-control" value="{{$data['value']}}" name="value" type="text" placeholder="Tên danh mục">
                </div>
            </div>
        </div>
